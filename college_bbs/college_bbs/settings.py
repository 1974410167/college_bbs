"""
Django settings for college_bbs project.
...
SECRET_KEY = 'django-insecure-nphr_uuxc$wtboq5ekm*rmh@k7i#dy$*4dikf+w0=_+(gmad+q'
...
# 十分钟内多次访问一个页面，浏览量算作一次
VISIT_TIME = datetime.timedelta(minutes=10)
...
WSGI_APPLICATION = 'college_bbs.wsgi.application'
